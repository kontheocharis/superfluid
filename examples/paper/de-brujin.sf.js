...
var lt_next = (p2) => (() => {
  ...
  return (() => {
    switch ((subject3)[0]) {
      case "lt-zero": return ["lt-zero"];
      case "lt-succ": return ((q3) => ["lt-succ", (lt_next)(q3)])((subject3)[1]);
    }
  })();
})();
var Lvl_p_ = null;
var lt_z_z_absurd = (p0) => (() => {
  var subject1 = p0;
  return (() => {
    switch ((subject1)[0]) {
      case "lt-zero": return z_neq_s;
      case "lt-succ": return ((q1) => z_neq_s)((subject1)[1]);
    }
  })();
})();
var lt_s_z_absurd = (p1) => (() => {
  var subject2 = p1;
  return (() => {
    switch ((subject2)[0]) {
      case "lt-zero": return z_neq_s;
      case "lt-succ": return ((q2) => z_neq_s)((subject2)[1]);
    }
  })();
})();
var lt_z_s_is_lt_zero = null;
var lt_s_s_is_lt_succ = (p2) => (null)(p2);
var main = (() => {
  var x0 = (js_uint_plus)(js_uint_one)((js_uint_plus)(js_uint_one)(0));
  var x1 = (() => {
    var x24151 = x0;
    return (() => {
      var subject2 = x24151;
      return ((p2) => x24151)(subject2);
    })();
  })();
  return (io_return)([]);
})();
