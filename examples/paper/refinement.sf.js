...
var debug_print = (a2) => (b3) =>
  unsafe_io(io_bind(js_console_log(a2))((_4) => io_return(b3)));
var is_just = (x1311) =>
  (() => {
    switch (x1311[0]) {
      case "nothing":
        return js_false;
      case "just":
        return ((x1352) => js_true)(x1311);
    }
  })();
var VOID = (m1) => null;
var sub = (m0) => (n1) =>
  js_zero_or_pos((_2) => m0)((x2) =>
    js_zero_or_pos((_3) => js_uint_zero)((x3) => sub(x3)(x2))(m0)
  )(n1);
var upgrade = (k1) =>
  js_zero_or_pos((_2) => (a3) => a3)(
    (x2) => (x3) => js_bounded_uint_inc(upgrade(x2)(x3))
  )(k1);
var find = (p1) => (xs2) =>
  js_array_switch_l((_3) => "nothing")(
    (a3) => (xs4) =>
      js_if_dep(p1(a3))((_5) => ["just", a3])((_5) => find(p1)(xs4))
  )(xs2);
var cong = [];
var sym = [];
var uip = trust_me;
...
var dec_to_bool = (x9111) =>
  (() => {
    switch (x9111[0]) {
      case "yes":
        return ((x9132) => js_true)(x9111);
      case "no":
        return ((x9162) => js_false)(x9111);
    }
  })();
var lte = (m0) => (n1) =>
  js_zero_or_pos((_2) => js_true)((x2) =>
    js_zero_or_pos((_3) => js_false)((x3) => lte(x2)(x3))(n1)
  )(m0);
var lt = (m0) => (n1) => js_and(js_not(js_eqq(m0)(n1)))(lte(m0)(n1));
var bool_eq = (a0) => (b1) =>
  js_if_dep(a0)((_2) => js_if_dep(b1)((_3) => js_true)((_3) => js_false))(
    (_2) => js_if_dep(b1)((_3) => js_false)((_3) => js_true)
  );
var char_eq = (c10) => (c21) =>
  ((f12) => ((f23) => js_eqq(f12)(f23))(c21))(c10);
...
var ascii_eq = (a10) => (a21) =>
  unsafe_complete(unsafe_complete(js_eqq(a10)(a21)));
var word_to_nat = (n0) => js_forget_bound(n0);
var Holds = null;
var determine = (x0) => js_if_dep(x0)((_1) => ["just", []])((_1) => "nothing");
var byte_vec_lookup = (s2) => (l3) => (d4) =>
  js_array_switch_l((_5) => d4([]))(
    (a5) => (xs6) =>
      (() => {
        var x12927 = a5;
        return (
          (k8) => (v9) =>
            ...
            )((_10) => v9([]))((_10) => byte_vec_lookup(s2)(xs6)(d4))
        )(x12927[0])(x12927[1]);
      })()
  )(l3);
var panic = (a1) =>
  unsafe_io(io_bind(js_console_log(a1))((_2) => js_exit(js_one)));
var reprs = (l1) => (t2) =>
  js_zero_or_pos((_3) => t2)((x3) => reprs(x3)(t2))(l1);
var unreprs = (l1) =>
  js_zero_or_pos((_2) => (a3) => a3)((x2) => (r3) => unreprs(x2)(r3))(l1);
...
var vec_index = (v2) =>
  (() => {
    var l3 = ((a3) => v2)(v2);
    return ((a5) => a5)(
      js_array_switch_l((_5) =>
        js_zero_or_pos((_6) => ((a8) => a8)((i8) => null))((x6) => null)(n1)
      )(
        (a5) => (xs6) =>
          js_zero_or_pos((_7) => null)((x7) =>
            ((a9) => a9)((i9) =>
              js_bounded_zero_or_pos(a5)((f11) =>
                (() => {
                  var p_p_13 = s_inj;
...
var main = (() => {
  var v0 = js_array_extend_l(1)(
    js_array_extend_l(2)(js_array_extend_l(3)(js_empty_array))
  );
