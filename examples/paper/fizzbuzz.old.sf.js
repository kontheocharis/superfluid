...
var if_then_else = (A0) => (b1) => (t2) => (f3) =>
  js_if_dep((x784) => A0)(b1)((_4) => t2(tt))((_4) => f3(tt));
...
var sub = (m0) => (n1) =>
  js_zero_or_pos((x1842) => JsUint)((_2) => m0)((x18442) =>
    js_zero_or_pos((x1873) => JsUint)((_3) => js_uint_zero)((x18453) =>
      sub(x18453)(x18442)
    )(m0)
  )(n1);
var upgrade = (n0) => (k1) =>
  js_zero_or_pos((m2) => null)((_2) => id(JsBoundedUint(n0)))(
    (x18462) => (x3) =>
      js_bounded_uint_inc(js_uint_plus(x18462)(n0))(upgrade(n0)(x18462)(x3))
  )(k1);
var type = (A0) => (_1) => A0;
var find = (A0) => (p1) => (xs2) =>
  js_array_switch_l(A0)((x4163) => Maybe(A0))((_3) => nothing)(
    (a3) => (xs4) =>
      js_if_dep((x4335) => Maybe(A0))(p1(xs4))((_5) => just(xs4))((_5) =>
        find(A0)(p1)(a3)
      )
  )(xs2);
...
var sym = (A0) => (x1) => (y2) => (e3) =>
  unsafe_cast(JsUndefined)(JsUndefined)(js_undefined);
var z_neq_s = (n0) => (p1) =>
  subst(JsUint)(js_uint_zero)(js_uint_plus(js_uint_one)(n0))((n2) =>
    js_zero_or_pos((x6503) => null)((_3) => Unit)((x18583) => Empty)(n2)
  )(p1)(tt);
var co_sym = (A0) => (x1) => (y2) => (m3) => (p4) => m3(sym(A0)(y2)(x1)(p4));
var s_inj = (n0) => (m1) => (e2) =>
  subst(JsUint)(js_uint_plus(js_uint_one)(n0))(js_uint_plus(js_uint_one)(m1))(
    (x3) => JsUndefined
  )(e2)(js_undefined);
var s_co_cong = (x0) => (y1) => (m2) => (p3) => m2(s_inj(x0)(y1)(p3));
var nat_eq_dep = (n0) => (m1) =>
  js_zero_or_pos((n2) => Dec(JsUndefined))((_2) =>
    js_zero_or_pos((m3) => Dec(JsUndefined))((_3) => yes(js_undefined))(
      (x18623) => no(z_neq_s(x18623))
    )(m1)
  )((x18612) =>
    js_zero_or_pos((m3) => Dec(JsUndefined))((_3) =>
      no(
        co_sym(JsUint)(js_uint_zero)(js_uint_plus(js_uint_one)(x18612))(
          z_neq_s(x18612)
        )
      )
    )((x18643) =>
      (() => {
        switch (nat_eq_dep(x18612)(x18643)[0]) {
          case 0:
            return ((e4) =>
              yes(
                cong(JsUint)(JsUint)(x18612)(x18643)((n5) =>
                  js_uint_plus(js_uint_one)(n5)
                )(e4)
              ))(nat_eq_dep(x18612)(x18643)[1]);
          case 1:
            return ((f4) => no(s_co_cong(x18612)(x18643)(f4)))(
              nat_eq_dep(x18612)(x18643)[1]
            );
        }
      })()
...
var dec_to_bool = (A0) => (x8301) =>
  (() => {
    switch (x8301[0]) {
      case 0:
        return ((x8322) => js_true)(x8301[1]);
      case 1:
        return ((x8352) => js_false)(x8301[1]);
    }
  })();
var lte = (m0) => (n1) =>
  js_zero_or_pos((x8402) => JsBool)((_2) => js_true)((x18652) =>
    js_zero_or_pos((x8433) => JsBool)((_3) => js_false)((x18663) =>
      lte(x18652)(x18663)
    )(n1)
  )(m0);
var lt = (m0) => (n1) =>
...
var bool_eq = (a0) => (b1) =>
  js_if_dep((x8472) => JsBool)(a0)((_2) =>
    js_if_dep((x8483) => JsBool)(b1)((_3) => js_true)((_3) => js_false)
  )((_2) =>
    js_if_dep((x8493) => JsBool)(b1)((_3) => js_false)((_3) => js_true)
  );
var Char = null;
        ...
        return ((f12) =>
          (() => {
            switch (c21[0]) {
              case 0:
                return ((f23) =>
                  js_eqq(JsBoundedUint(js_uint_pow(2)(32)))(
                    JsBoundedUint(js_uint_pow(2)(32))
                  )(f12)(f23))(c21[1]);
            }
          })())(c10[1]);
    }
            ...
            (() => {
              switch (s21[0]) {
                ...
                case 1:
                  return (
                    (c24) => (s2_p_5) =>
                      js_and(char_eq(c12)(c24))(string_eq(s1_p_3)(s2_p_5))
                  )(s21[1])(s21[2]);
              }
            })()
        )(s10[1])(s10[2]);
...
var ascii_eq = (a10) => (a21) =>
  js_eqq(JsBoundedUint(256))(JsBoundedUint(256))(a10)(a21);
var word_to_nat = (n0) => js_forget_bound(65536)(n0);
var Holds = (b0) => JsUndefined;
var determine = (x0) =>
  js_if_dep((x1) => Maybe(JsUndefined))(x0)((_1) => just(js_undefined))(
    (_1) => nothing
  );
var byte_vec_length = (n0) => (b1) => n0;
var byte_vec_lookup = (n0) => (T1) => (s2) => (l3) => (d4) =>
  js_array_switch_l(Sigma(Sigma(JsBuffer)((l5) => JsUndefined))((_5) => null))(
    (x12025) => T1
  )((_5) => d4(tt))(
    (a5) => (xs6) =>
      (() => {
        switch (xs6[0]) {
          case 0:
            return (
              (k7) => (v8) =>
                if_then_else(T1)(
                  js_buffer_eq(fst(JsBuffer)((x16479) => JsUndefined)(s2))(
                    fst(JsBuffer)((x16579) => JsUndefined)(k7)
                  )
                )((_9) => v8(tt))((_9) => byte_vec_lookup(n0)(T1)(s2)(a5)(d4))
            )(xs6[1])(xs6[2]);
        }
      })()
  )(l3);
var panic = (A0) => (a1) =>
  unsafe_io(A0)(
    io_bind(Unit)(A0)(js_console_log(STRING)(a1))((_2) => js_exit(A0)(js_one))
  );
var Reprs = (l0) => (T1) =>
  js_zero_or_pos((x16692) => null)((_2) => T1)((x18732) => Reprs(x18732)(T1))(
    l0
  );
var reprs = (T0) => (l1) => (t2) =>
  js_zero_or_pos((l3) => Reprs(l3)(T0))((_3) => t2)((x18743) =>
    reprs(T0)(x18743)(t2)
  )(l1);
var unreprs = (T0) => (l1) =>
  js_zero_or_pos((l2) => null)((_2) => id(Reprs(js_uint_zero)(T0)))(
    (x18752) => (r3) => unreprs(T0)(x18752)(r3)
  )(l1);
    ...
    switch (r2[0]) {
      case 0:
        return (
          (l4) => (p5) =>
            unreprs(A0)(l4)(
              subst_type(B1)(Reprs(l4)(A0))(sym(null)(Reprs(l4)(A0))(B1)(p5))(
                b3
              )
            )
        )(r2[1])(r2[2]);
...
var get_fizzbuzz = (n0) =>
  js_if_dep((x18241) => Maybe(FizzBuzz))(
    js_eqq(JsUint)(JsUint)(js_uint_mod(n0)(15))(0)
  )((_1) => just(fizzbuzz))((_1) =>
    js_if_dep((x18262) => Maybe(FizzBuzz))(
      js_eqq(JsUint)(JsUint)(js_uint_mod(n0)(3))(0)
    )((_2) => just(fizz))((_2) =>
      js_if_dep((x18283) => Maybe(FizzBuzz))(
        js_eqq(JsUint)(JsUint)(js_uint_mod(n0)(5))(0)
      )((_3) => just(buzz))((_3) => nothing)
    )
  );
var repeat = (n0) => (f1) =>
  js_zero_or_pos((x18312) => IO(Unit))((_2) => io_return(Unit)(tt))((x18762) =>
    io_bind(Unit)(Unit)(f1(n0))((_3) => repeat(x18762)(f1))
  )(n0);
var main = repeat(10000)((n0) =>
  js_console_log(STRING)(fizzbuzz_to_string(get_fizzbuzz(n0)))
);
main();
