...
var snoc_list_list_repr_same = [];
var snoc_to_cons = (a1) => a1;
var cons_to_snoc = (a1) => a1;
var palindrome = (xs0) => (js_array_switch_l)((_1) => js_true)((a1) => (xs2) => (js_array_switch_r)((_3) => js_true)((xs3) => (a4) => (js_if_dep)((js_eqq)(a1)(a4))((_5) => (palindrome)((snoc_to_cons)(xs3)))((_5) => js_false))((cons_to_snoc)(xs2)))(xs0);
(main)((x) => x)